...
The code consists in 2 different programs for both M5Stack and ProMicro controller. The M5Stack is the main controller and connects by I2C with the ProMicro, wich controls everithing related to HC-04
