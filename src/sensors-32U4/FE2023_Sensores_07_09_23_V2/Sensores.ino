...
/*void imprimirSensores() { //Prints by Serial the sensor data
  ...
  Serial.println(String("ENC IZQ: ") + motorGetCount("I") + String("  ENC DER: ") + motorGetCount("D") + String("  ENC MOTOR: ") + motorGetCount("M"));
  Serial.println("\n\n");
  }*/
...
void imprimirSensores() { //Prints by Serial the sensor data
  Serial.println(String("Izquierdo=") + sensor.sr04[0] + String("  Centro=") + sensor.sr04[1] + String("  Derecho=") + sensor.sr04[2]);
  Serial.println(String("ENC IZQ: ") + motorGetDistancia("I") + String("  ENC DER: ") + motorGetDistancia("D") + String("  MOTOR: ") + encoderMcontador + String("  VELOCIDAD: ") + sensor.velocidad);
